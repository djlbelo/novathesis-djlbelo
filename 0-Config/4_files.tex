...
%-------------------------------------------------------------
\ntaddfile{chapter}{chapter1}   % Introduction
\ntaddfile{chapter}{chapter2}   % Background and Related Work
\ntaddfile{chapter}{chapter3}   % Proposed Approach
\ntaddfile{chapter}{chapter4}   % Implementation
\ntaddfile{chapter}{chapter5}   % Evaluation
\ntaddfile{chapter}{chapter6}   % Conclusion
